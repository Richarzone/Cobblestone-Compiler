...
_lr_productions = [
  ...
  ('program -> PROGRAM MAIN expressions END PROGRAM MAIN','program',6,'p_init','yacc.py',24),
  ('expressions -> expressions expression','expressions',2,'p_expressions','yacc.py',37),
  ('expressions -> expression','expressions',1,'p_expressions_expression','yacc.py',43),
  ('expression -> var_declaration','expression',1,'p_expression','yacc.py',48),
  ('expression -> if_statement','expression',1,'p_expression','yacc.py',49),
  ('expression -> for_loop','expression',1,'p_expression','yacc.py',50),
  ('expression -> while_loop','expression',1,'p_expression','yacc.py',51),
  ('expression -> print','expression',1,'p_expression','yacc.py',52),
  ('expression -> empty','expression',1,'p_expression','yacc.py',53),
  ('data_type -> INT','data_type',1,'p_data_type','yacc.py',60),
  ('data_type -> REAL','data_type',1,'p_data_type','yacc.py',61),
  ('data_type -> BOOLEAN','data_type',1,'p_data_type','yacc.py',62),
  ('data_type -> STRING','data_type',1,'p_data_type','yacc.py',63),
  ('var_declaration -> data_type DOUBLECOLON declarations','var_declaration',3,'p_variable','yacc.py',68),
  ('declarations -> IDENTIFIER COMMA declarations','declarations',3,'p_declarations','yacc.py',73),
  ('declarations -> IDENTIFIER','declarations',1,'p_declarations','yacc.py',74),
  ('var_declaration -> IDENTIFIER ASSING statement','var_declaration',3,'p_variable_assignation','yacc.py',84),
  ('statement -> IDENTIFIER','statement',1,'p_statement_variable','yacc.py',89),
  ('statement -> statement PLUS statement','statement',3,'p_statement','yacc.py',94),
  ('statement -> statement MINUS statement','statement',3,'p_statement','yacc.py',95),
  ('statement -> statement TIMES statement','statement',3,'p_statement','yacc.py',96),
  ('statement -> statement DIVIDE statement','statement',3,'p_statement','yacc.py',97),
  ('statement -> INT','statement',1,'p_statement','yacc.py',98),
  ('statement -> REAL','statement',1,'p_statement','yacc.py',99),
  ('statement -> BOOLEAN','statement',1,'p_statement','yacc.py',100),
  ('statement -> STRING','statement',1,'p_statement','yacc.py',101),
  ('statement -> L_PARENTHESIS statement R_PARENTHESIS','statement',3,'p_statement_parenthesis','yacc.py',110),
  ('statement -> L_PARENTHESIS conditional R_PARENTHESIS','statement',3,'p_statement_parenthesis','yacc.py',111),
  ('conditional -> conditional EQUAL conditional','conditional',3,'p_conditional','yacc.py',117),
  ('conditional -> conditional NOT_EQUAL conditional','conditional',3,'p_conditional','yacc.py',118),
  ('conditional -> conditional GREATER conditional','conditional',3,'p_conditional','yacc.py',119),
  ('conditional -> conditional LESS conditional','conditional',3,'p_conditional','yacc.py',120),
  ('conditional -> conditional GREATER_EQUAL conditional','conditional',3,'p_conditional','yacc.py',121),
  ('conditional -> conditional LESS_EQUAL conditional','conditional',3,'p_conditional','yacc.py',122),
  ('conditional -> conditional AND conditional','conditional',3,'p_conditional','yacc.py',123),
  ('conditional -> conditional OR conditional','conditional',3,'p_conditional','yacc.py',124),
  ('conditional -> TRUE','conditional',1,'p_conditional','yacc.py',125),
  ('conditional -> FALSE','conditional',1,'p_conditional','yacc.py',126),
  ('conditional -> statement','conditional',1,'p_conditional','yacc.py',127),
  ('if_statement -> IF L_PARENTHESIS conditional R_PARENTHESIS THEN L_BRACE expressions R_BRACE','if_statement',8,'p_if_statement','yacc.py',136),
  ('if_statement -> IF L_PARENTHESIS conditional R_PARENTHESIS THEN L_BRACE expressions R_BRACE ELSE L_BRACE expressions R_BRACE','if_statement',12,'p_if_statement','yacc.py',137),
  ('for_loop -> FOR L_PARENTHESIS statement SEMMICOLON conditional SEMMICOLON var_declaration R_PARENTHESIS L_BRACE expressions R_BRACE','for_loop',11,'p_for_loop','yacc.py',145),
  ('while_loop -> WHILE L_PARENTHESIS conditional R_PARENTHESIS DO L_BRACE expressions R_BRACE','while_loop',8,'p_while_loop','yacc.py',150),
  ('print -> PRINT L_PARENTHESIS statement R_PARENTHESIS','print',4,'p_print','yacc.py',155),
